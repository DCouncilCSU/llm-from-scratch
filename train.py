...
def get_lr(step, warmup_steps, max_steps, max_lr, min_lr):
    # Ramp the learning rate from near-zero up to max_lr
    ...
    # Cosine decay - smoothly decrease the learning rate
...
def train(data_path, max_steps=5000, batch_size=64, n_layer=6,
    n_head=6, n_embd=384, block_size=256):
